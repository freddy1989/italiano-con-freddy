const CACHE='italiano-con-shazzy-v4.4-stickers';
const ASSETS=['./','./index.html','./styles.css','./app.js','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png','./stickers/sticker-1.png','./stickers/sticker-2.png','./stickers/sticker-3.png','./stickers/sticker-4.png','./stickers/sticker-5.png','./stickers/sticker-6.png'];
